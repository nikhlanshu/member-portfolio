...
public class AdminController {
     ...
     * @param confirmMemberRequest  The confirmation request details.
     * @return Updated MemberResponse.
     */
    @PatchMapping(value = "/members/{memberId}/confirm", produces = MediaType.APPLICATION_JSON_VALUE)
    public Mono<ResponseEntity<MemberResponse>> approveMember(
            @PathVariable String memberId,
            @Valid @RequestBody ConfirmMemberRequest confirmMemberRequest) {
     ...
     * @param rejectMemberRequest The rejection reason/details.
     * @return Updated MemberResponse.
     */
    ...
    public Mono<ResponseEntity<MemberResponse>> rejectMember(
            @PathVariable String memberId,
            @Valid @RequestBody RejectMemberRequest rejectMemberRequest) {
