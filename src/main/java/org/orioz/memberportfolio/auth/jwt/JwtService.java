...
public class JwtService {
    ...
    public Mono<String> generateIdToken(Member member) {
        ...
        return Mono.fromCallable(() -> Jwts.builder()
                ...
                .claim("memberSince", payload.getMemberSince() != null ? payload.getMemberSince().toString() : null)
                .claim("membershipDuration", payload.getDuration() != null ? payload.getDuration() : null)
